...
import Chain.Consensus.FBA.FBA_transition as state_transitions
import Chain.Consensus.FBA.FBA_timeouts as timeouts
import Chain.Consensus.FBA.FBA_messages as messages
...
class FBA():
    ...
    PBFT State:
        ...
        state - FBA node state (new_round, pre-prepared, prepared, committed, round_change)]
    ...
    def create_FBA_block(self, time):
